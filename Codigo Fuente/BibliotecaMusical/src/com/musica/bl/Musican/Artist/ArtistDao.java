...
public class ArtistDao implements IArtistDao {
    ...
    public int save(Artist artist) throws Exception {
        int message = -1;
        String insertDead = artist.getDead() != null ? "dead," : "";
        String valueDead = artist.getDead() != null ? "'" + artist.getDead() +"', " : "";
        String queryString = "INSERT INTO Artist(name, lastName, born, " + insertDead + " country, old, reference, description, idGender, artistName) " +
                "VALUES('"+ artist.getName() +"', '" + artist.getLastName() +"', '" + artist.getBorn() + "', " + valueDead +
    ...
    public boolean update(Artist artist) throws Exception {
        ...
        String updateDead = artist.getDead() != null ? " dead= '" + artist.getDead() + "' ," : "";
        String queryString = "UPDATE Artist SET name= '"+ artist.getName() +"', lastName= '" + artist.getLastName() + "', " +
                "born= '" + artist.getBorn() + "' , " + updateDead + " old= " + artist.getOld() + " , " +
