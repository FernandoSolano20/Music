...
public class Controller {
    ...
    public boolean registerClient(int id, String name, String lastName, int old, String country, String email, String pass, String userName, String image) throws Exception {
        ...
        if(userDao.getUserByEmail(client.getEmail()) == null && userDao.getUserByUserName(client.getUserName()) == null && userDao.getUserById(client.getId()) == null) {
    ...
    public boolean registerAdmin(int id, String name, String lastName, String email, String pass, String userName, String image) throws Exception {
        ...
        if(userDao.getUserByEmail(admin.getEmail()) == null && userDao.getUserByUserName(admin.getUserName()) == null && userDao.getUserById(admin.getId()) == null) {
    ...
    public boolean validatePassword(String pass){
        Pattern pattern = Pattern.compile("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\W).{8,10}$");
            ...
            if(gen != null){
                ...
                if(artist1 != null){
                    ...
                    if(compositor1 != null){
                        ...
                        if(songDao.searchSongByName(song.getName()) == null){
    ...
    public boolean registerGender(String name, String description) throws Exception {
        ...
        if(searchGenderByName(name) == null){
    ...
    public boolean registerArtist(String name, String lastName, String country, LocalDate dateBorn, LocalDate dateDead, String reference, String description, String gender, String artistName) throws Exception {
        ...
        if(gen != null){
            ...
            if(artistDao.searchArtistByArtistName(artistName) == null){
    ...
    public boolean registerCompositor(String name, String lastName, String country, int old, String[] genders) throws Exception {
        ...
        if (compositorDao.searchCompositorByNameAndLastName(name + " " + lastName) == null){
     ...
     * Album section
     */
    public boolean registerAlbum(String name, LocalDate release, String image, String[] artists, String nameSong, String gender, String art, String comp, int year, int month, int day, int price, int score, String songPath) throws Exception {
        Album album = new Album(name,release,image);
        for (String artist:artists) {
            Artist artist1 = artistDao.searchArtistByArtistName(artist);
            if(artist1 != null){
                album.setArtists(artist1);
            }
        }
        if (searchAlbumByName(name) == null){
            int id = albumDao.save(album);
            if(id != -1){
                registerSong(nameSong,gender,art,comp,year,month,day,album.getName(),score,songPath,price);
                album.setId(id);
