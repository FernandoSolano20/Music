...
-- -----------------------------------------------------
-- Table `Music`.`UserList`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Music`.`UserList` (
...
CREATE TABLE IF NOT EXISTS `Music`.`User` (
  ...
  `idUserList` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_User_UserList1_idx` (`idUserList` ASC) VISIBLE,
  CONSTRAINT `fk_User_UserList1`
    FOREIGN KEY (`idUserList`)
    REFERENCES `Music`.`UserList` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Music`.`UserListSong`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Music`.`UserListSong` (
  `idUserList` INT NOT NULL,
  `idSong` INT NOT NULL,
  PRIMARY KEY (`idUserList`, `idSong`),
  INDEX `fk_UserList_has_Song_Song1_idx` (`idSong` ASC) VISIBLE,
  INDEX `fk_UserList_has_Song_UserList1_idx` (`idUserList` ASC) VISIBLE,
  CONSTRAINT `fk_UserList_has_Song_UserList1`
    FOREIGN KEY (`idUserList`)
    REFERENCES `Music`.`UserList` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_UserList_has_Song_Song1`
    FOREIGN KEY (`idSong`)
