package com.musica.ui.views.Compositor.Lists;
...
public class ListCompositor extends MusicUI implements Initializable {
    @FXML
                        ...
                        EventHandler<ActionEvent> event = new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent t) {
                                try {
                                    ...
                                    boolean response = controller.deleteCompositor(Integer.parseInt(btnCell.getIdBtn()));
                                    if (response){
                                        AlertHelper.showAlert(Alert.AlertType.CONFIRMATION, owner, "Exitoso", "Compositor eliminado");
                                        ListCompositor.super.rComp(t);
                                    }
                                    else {
