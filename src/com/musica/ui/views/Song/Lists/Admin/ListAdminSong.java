package com.musica.ui.views.Song.Lists.Admin;

import com.musica.ui.AlertHelper;
import com.musica.ui.ButtonCell;
import com.musica.ui.MusicUI;
import com.musica.ui.views.Gender.Lists.ListGender;
...
public class ListAdminSong extends MusicUI implements Initializable {
    @FXML
                        ...
                        EventHandler<ActionEvent> event = new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent t) {
                                try {
                                    ...
                                    if (response){
                                        AlertHelper.showAlert(Alert.AlertType.CONFIRMATION, owner, "Exitoso", "Cancion eliminado");
                                        ListAdminSong.super.rSongAdmin(t);
                                    }
                                    else {
